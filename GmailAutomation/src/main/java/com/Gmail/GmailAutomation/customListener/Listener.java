package com.Gmail.GmailAutomation.customListener;
...
public class Listener extends TestBase implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		...
		if(!result.isSuccess()){
			...
			// here result.getName() exactly give you the method name, which is actually got failed in runtime
			...
			try {
				...
				//This will create a link of screenshot to your testng report 
	...
	//extending TestBase is mandatory, otherwise, the browser will not be initialized. 
	//Because this is the central location, from their we are taking decision
