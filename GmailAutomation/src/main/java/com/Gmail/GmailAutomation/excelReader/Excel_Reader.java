package com.Gmail.GmailAutomation.excelReader;
...
public class Excel_Reader {
	...
	public Excel_Reader(String path) {
		...
		try {
			...
			//workbook is the one which has all sheet name.
	...
	//The below code i made to read any particular cell data
	@SuppressWarnings("deprecation")
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
			...
			//We want to know how many columns are there in the sheet 0th row (which contains headers)
			...
			if (cell.getCellType() == Cell.CELL_TYPE_STRING) {
				...
				//If it is (cell) is blank, that somebody has not written anything then you just return blank as below
				return "";
			}
